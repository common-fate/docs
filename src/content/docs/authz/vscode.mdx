...
![Screenshot of Cedar VS Code extension with autocomplete feature.](./images/cedar-vscode-autocomplete.png)
...
![Common Fate uses Cedar v3, which requires the pre-release version of the Cedar VS Code extension.](./images/cedar-vscode-prerelease.png)
...
![Screenshot of Cedar VS Code extension with policy editing](./images/cedar-vscode-screenshot.png)
