...
![Tab Containers](assets/tab-containers.png)
...
![Granted Firefox Menu Icon](assets/granted-firefox-menu-icon.png)
...
![Granted Firefox Menu](assets/granted-firefox-menu.png)
