...
![Authorization Log List](/images/authz-log-list.png)
...
![Find your Common Fate user ID](/images/cf-find-user-id.png)
...
![Evaluation Example](/images/cf-eval-example.png)
...
![No Matching Policy]( /images/cf-eval-example-no-matching-policy.png )
...
![Authorization Audit Trail](/images/cf-access-request-authz-audit-trail.png)
...
![Add Filter](/images/cf-eval-add-filter.png)
...
![Filter Cell](/images/cf-eval-filter-cell.png)
