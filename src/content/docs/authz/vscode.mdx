...
![Screenshot of Cedar VS Code extension with autocomplete feature.](assets/cedar-vscode-autocomplete.png)
...
![Common Fate uses Cedar v3, which requires the pre-release version of the Cedar VS Code extension.](assets/cedar-vscode-prerelease.png)
...
![Screenshot of Cedar VS Code extension with policy editing](assets/cedar-vscode-screenshot.png)
