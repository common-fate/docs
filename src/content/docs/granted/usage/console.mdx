...
![Tab Containers](../images/tab-containers.png)
...
![Granted Firefox Menu Icon](../images/granted-firefox-menu-icon.png)
...
![Granted Firefox Menu](../images/granted-firefox-menu.png)
