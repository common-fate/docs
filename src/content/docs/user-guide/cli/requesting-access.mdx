...
![Cedar Authorization Workflow](../../authz/images/cedar-authorization-workflow.png)
...
![Slack Commands](/images/end-user/slack-commands.png)

Press enter after typing `/access` and you will be navigated to a pop-up through which
you can select the resource type.

![Slack Integrations List](/images/end-user/slack-integrations-list.png)
...
![Slack Approve](/images/end-user/slack-approve.png)
...
![Slack Extend](/images/end-user/slack-extend.png)
...
![Slack Close](/images/end-user/slack-approve.png)
...
![Breakglass Activate](/images/end-user/breakglass-activate.png)

### Extend Request

Navigate to the Access tab in the sidebar, locate the request, and click Extend:

![Extend Request](/images/end-user/extend.png)
...
![Close Request](/images/end-user/close.png)
