...
![An example policy validation check in GitHub Actions.](./images/cedar-ci-screenshot.png)
...
![Annotations in GitHub Actions showing where issues are.](./images/cedar-ci-github-annotations.png)
...
![Store the OIDC Client Secret as a secret, with the key CF_OIDC_CLIENT_SECRET](./images/cedar-ci-github-secret.png)
...
```gpg title="common-fate-signing-key.asc"
...
![An example GitHub Actions access tests run](./images/access-test-run.png)
