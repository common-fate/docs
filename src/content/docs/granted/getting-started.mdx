...
<Tabs>
  <TabItem label="MacOS">
    ...
    ```bash
    curl -OL https://releases.commonfate.io/granted/v0.38.0/granted_0.38.0_darwin_x86_64.tar.gz
    ...
    ```bash
    curl -OL https://releases.commonfate.io/granted/v0.38.0/granted_0.38.0_darwin_arm64.tar.gz
    ...
    brew extract --version=0.38.0 common-fate/granted/granted $USER/local-tap
    brew install granted@0.38.0
    ```
  ...
  <TabItem label="Linux (Manual)">
    ...
    >
      ...
      <TabItem label="x86_64">
        ...
        ```bash
        curl -OL releases.commonfate.io/granted/v0.38.0/granted_0.38.0_linux_x86_64.tar.gz
      ...
      <TabItem label="arm64">
        ...
        ```bash
        curl -OL releases.commonfate.io/granted/v0.38.0/granted_0.38.0_linux_arm64.tar.gz
      ...
      <TabItem label="i386">
        ...
        ```bash
        curl -OL releases.commonfate.io/granted/v0.38.0/granted_0.38.0_linux_i386.tar.gz
  ...
  <TabItem label="Windows">
    ...
    [Granted for Windows x86_64](https://releases.commonfate.io/granted/v0.38.0/granted_0.38.0_windows_x86_64.zip)

    [Granted for Windows arm64](https://releases.commonfate.io/granted/v0.38.0/granted_0.38.0_windows_arm64.zip)

    [Granted for Windows i386](https://releases.commonfate.io/granted/v0.38.0/granted_0.38.0_windows_i386.zip)
